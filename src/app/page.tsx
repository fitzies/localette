          ...
          <div className="mx-auto max-w-7xl px-6 md:px-12">
            <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
              ...
              >
                ...
                <span className="text-sm">Join early for greater exposure</span>
              ...
              <p className="mx-auto mt-8 hidden max-w-2xl text-wrap text-lg sm:block">
                Localatte connects Singapore's home-based businesses with eager
                customers, offering a simple platform to showcase goods and
                boost local exposure. Join early to grow your venture into a
                community favorite!
              </p>
